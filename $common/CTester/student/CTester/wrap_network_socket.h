...
struct stats_send_t {
    ...
    struct params_send_t last_params_buffered; // Pointers should be allocated so that the monitoring function can copy the arguments content to their.
    ssize_t last_return;
};
struct stats_sendto_t {
    int called;
    struct params_sendto_t last_params;
    struct params_sendto_t last_params_buffered; // Pointers should be allocated so that the monitoring function can copy the arguments content to their.
    ssize_t last_return;
};
