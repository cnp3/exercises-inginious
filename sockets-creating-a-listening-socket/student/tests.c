...
void test_create_socket_socket_call() {
    set_test_metadata("create-listening-socket", _("Checks that the socket call is correct"), 1);
...
void test_create_socket_failing_socket_call() {
    set_test_metadata("create-listening-socket", _("Checks that the socket call failure is handled correctly"), 1);
...
void test_create_socket_bind_call() {
    set_test_metadata("create-listening-socket", _("Checks that the bind call is correct"), 1);
...
void test_create_socket_failing_bind_call() {
    set_test_metadata("create-listening-socket", _("Checks that the bind call failure is handled correctly"), 1);
...
void test_create_socket_recvfrom_call() {
    set_test_metadata("create-listening-socket", _("Checks that the recvfrom call is correct"), 1);
...
void test_create_socket_failing_recvfrom_call() {
    set_test_metadata("create-listening-socket", _("Checks that the recvfrom call failure is handled correctly"), 1);
...
void test_create_socket_sendto_call() {
    set_test_metadata("create-listening-socket", _("Checks that the sendto call is correct"), 1);
...
void test_create_socket_sent_content_call() {
    set_test_metadata("create-listening-socket", _("Checks that the content sent is correct"), 1);
...
void test_create_socket_failing_sendto_call() {
    set_test_metadata("create-listening-socket", _("Checks that the sendto call failure is handled correctly"), 1);
